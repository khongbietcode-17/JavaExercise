...
public class Bai8TH extends JPanel {
    public Bai8TH() {
        ...
        col.add(new JButton("Col Button 1"));
        col.add(new JButton("Col Button 2"));
        col.add(new JButton("Col Button 3"));
